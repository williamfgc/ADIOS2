...
if(NOT pugixml_FOUND)
  ...
  if(pugixml_FOUND AND NOT TARGET pugixml::pugixml)
    ...
    target_sources(pugixml_private INTERFACE
      $<BUILD_INTERFACE:${pugixml_INCLUDE_DIR}/pugiconfig.hpp>
      $<BUILD_INTERFACE:${pugixml_INCLUDE_DIR}/pugixml.hpp>
    )
    target_link_libraries(pugixml_private INTERFACE ${pugixml_LIBRARY})
    install(TARGETS pugixml_private EXPORT adios2Exports)
  endif()
